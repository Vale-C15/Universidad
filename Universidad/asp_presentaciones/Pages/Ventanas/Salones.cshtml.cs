...
namespace asp_presentaciones.Pages.Ventanas
{
    ...
    {
        private ISalonesPresentacion? iPresentacion = null;

        public SalonesModel(ISalonesPresentacion iPresentacion)
        {
            try
            {
        ...
        [BindProperty] public Salones? Actual { get; set; }
        [BindProperty] public Salones? Filtro { get; set; }
